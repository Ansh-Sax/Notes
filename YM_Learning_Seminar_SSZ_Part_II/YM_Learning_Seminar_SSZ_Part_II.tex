...
Note that we expect the corollaries of the Log-Sobolev ineqality (Poincare and consequently decay of correlations and so on) to be true $\forall\beta$ given any $N$, so we are still a long way off!
